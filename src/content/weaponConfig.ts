...
export const PLASMA_RIFLE_CONFIG: WeaponConfig = {
  ...
  recoil: {
    ...
    adsMultiplier: 0.5,
    yawScale: 0.9,
    // Viewmodel punch only — camera pattern / recovery left unchanged.
    visualKick: 0.12,
    visualRecoverySpeed: 16,
    adsVisualMultiplier: 0.35,
    visualStyle: {
      rotX: 0.04,
      rotYFromYaw: -0.025,
      rotZ: -0.02,
...
export const PISTOL_CONFIG: WeaponConfig = {
  ...
  view: {
    ...
    remoteMeshEuler: { x: 0, y: 0, z: 0 },
    fpArmsGrip: {
      hip: { x: 0.55 * -5.2, y: 0, z: 0 },
      ads: { x: 0.55 * -5.2, y: 0, z: 0 },
    },
  },
  recoil: {
